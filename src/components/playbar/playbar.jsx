...
export default function Playbar(props) {
  const {
    playerState, currentSong, elapsedPercent, progressBarRef, // data
    closeSidenav, closeSidenavRight, // ui state
    handleJumpTo, handlePrevious, handleNext, handlePause, handlePlay, // pass down functions
  } = props;
    ...
    <footer className="footer">
      <div className="progress" onMouseDown={handleJumpTo}>
        <div
          ...
          role="progressbar"
          ref={progressBarRef}
          style={{ width: `${elapsedPercent.toString()}%` }}
          aria-valuenow="25"
          aria-valuemin="0"
          aria-valuemax="100"
        />
